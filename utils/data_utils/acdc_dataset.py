...
class ACDCTrainDataset(Dataset):
    """
    A custom PyTorch dataset for the ACDC data.

    Args:
        x (numpy.ndarray): The input images.
        y (numpy.ndarray): The target masks.
        img_size (tuple): The size of the images.
        transform (callable, optional): A function/transform to be applied on the images and masks. Default is None.
        convert_to_single (bool, optional): Whether to convert the target masks to single-channel. Default is False.
    """
